...
str_loop1:  ; the simple method
    ...
    ; fill string with ascii zeros
    prnt    string2, 20
    mov     rax, 48
    mov     rdi, my_string
    mov     rcx, length
    
str_loop2:  ; no inc rdi needed anymore
    stosb
    loop    str_loop2
    prnt    my_string, length
    
    ; fill the string with ascii ones
    prnt    string3, 19
    mov     rax, 49
    mov     rdi, my_string
    mov     rcx, length
    ...
    ; fill the string again with printable ascii chars
    prnt    string4, 26
    mov     rax, 32
    mov     rdi, my_string
    mov     rcx, length
    
str_loop3:  ; simple method
    mov     byte [rdi], al
    inc     rdi
    inc     al
    loop    str_loop3 
    ...
    prnt    string5, 32
    mov     rsi, my_string      ; rsi is source
    mov     rdi, other_string   ; rdi is destination
    mov     rcx, length
    rep     movsb   
    ...
    mov     rcx, 27             ; copy only 27-1 chars
