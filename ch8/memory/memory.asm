...
section .data
    bNum    db          123
    wNum    dw          12345
    warray  times 5 dw  0   ; array of five words containing 0
    dNum    dd          12345
    qNum1   dq          12345
    text1   db          "abc",0
...
main:
    ...
    mov     rax, [bNum]     ; load value at bNum into rax
    ...
    mov     rax, text1+1    ; load address of second text1 char into rax
    lea     rax, [text1+1]  ; load address of second text1 char into rax
    mov     rax, [text1]    ; load content starting at text1 into rax
    mov     rax, [text1+1]  ; load content starting at text1+1 into rax
    mov     rsp, rbp
    pop     rbp
    ret