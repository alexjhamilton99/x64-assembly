...
extern printf
section .data
	dummy		db	13	; dummy variable that purposefully misaligns the memory
align 16	; NASM assembler directive that aligns memory
	spvector1	dd	1.1
			dd	2.2
			dd	3.3
			dd	4.4
...
main:
	...
	; add 2 single precision fl-pt vectors
	mov	rsi, spvector1
	mov	rdi, fmt1
	call	printspfp
	...
	; add 2 double precision fl-pt vectors
	mov	rsi, dpvector1
	mov	rdi, fmt4
	call	printdpfp
...
printspfp:
	...
	movss		xmm0, [rsi]
	cvtss2sd	xmm0, xmm0	; printf expects a double-precision arg
	movss		xmm1, [rsi+4]
	cvtss2sd	xmm1, xmm1
	movss		xmm2, [rsi+8]
	cvtss2sd	xmm2, xmm2
