...
main:
	...
	; add 2 single precision floating-pt vectors
	mov	rsi, spvector1
	mov	rdi, fmt1
	call	printspfp
...
printspfp:
	...
	movss		xmm3, [rsi+12]
	cvtss2sd	xmm3, xmm3
	mov		rax, 4		; copy the 4 single-precision floats into the accumulator register
	call		printf
...
printdpfp:
	...
	movsd	xmm0, [rsi]
	movsd	xmm1, [rsi+8]
	mov	rax, 2		; copy the 2 double-precision floats into the accumlator register
	call	printf
