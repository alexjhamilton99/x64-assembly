...
main:
	...
	; load vector1 in register ymm
	vmovups		ymm0, [spvector1]
	; extract ymm0
	vextractf128	xmm2, ymm0, 0
	; ymm0's first part
	vextractf128	xmm2, ymm0, 1		; ymm0's second part
	; load vector 2 into ymm1
	vmovups		ymm1, [spvector2]	; extract ymm1
	vextractf128	xmm2, ymm1, 0
	vextractf128	xmm2, ymm1, 1
	; added 2 single precision floating-pt vectors
	...
	; load vector 1 into register ymm0
	vmovups		ymm0, [dpvector1]
	mov		rdi, fmt4
	; extract ymm0
	vextractf128	xmm2, ymm0, 0		; ymm0's first part
	vextractf128	xmm2, ymm0, 1		; ymm0's second part
	; load vector 2 into register ymm1
	vmovups		ymm1, [dpvector2]	
	; extract ymm1
	vextractf128	xmm2, ymm1, 0
	vextractf128	xmm2, ymm1, 1
	; add 2 double precision floating-pt vectors
